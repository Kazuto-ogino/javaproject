...
public class UserDAO {
	...
	public void resetPassword(String username,String newPasword) {
		User user = users.get(username);
		if (user != null) {
			users.put(username, new User(user.getUsername(), hashPassword(newPasword), user.getRole(),user.isEnabled()));
		}
	}
